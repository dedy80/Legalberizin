      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-1 md:grid-cols-12 gap-10">
        <div className="md:col-span-5">
          <div className="flex items-center gap-2.5">
            <span className="w-9 h-9 rounded-lg bg-gradient-to-br from-sky-500 to-blue-700 flex items-center justify-center font-extrabold text-white text-lg">L</span>
            <span className="font-extrabold tracking-tight text-lg text-white">
              LEGAL<span className="text-gradient">BERIZIN</span><span className="text-sky-300">.id</span>
            </span>
          </div>
